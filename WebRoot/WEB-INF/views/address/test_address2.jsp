...
<html>
    ...
    <body>
        ...
        <form action="<%=basePath%>userAddress/editAndGetWXAddress?type=3" id="orderForm" method="post">
            ...
            <div class="submit_box">
            	...
            	<div class="bton_submitbox">
            		<input type="button" class="confirm_bton" value="提交订单" onclick="query('<%=basePath%>userAddress/editAndGetWXAddress?type=3')"/>
            	</div>

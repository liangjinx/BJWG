...
<html>
	<head>
		...
		<style>
			...
			.amend_container .amend_password_box2:nth-child(2) .amend_tips, .amend_container .amend_password_box2:nth-child(3) .amend_tips { margin: 0 20px 0 5px;}
	...
	<body>
		<form action="<%=basePath %>wpv/wlpayPasswordModify2" id="allProjectForm" name="allProjectForm" method="post">
        	<div class="amend_content">
	        	<div class="amend_container">
	        		...
	        		<div class="amend_password_box2">
	        			<p class="amend_tips">旧支付密码：</p>
	        			<input type="password" name="oldPassword" id="oldPassword" class="am_password" size="5" maxlength="6" onkeyup="value=value.replace(/[^\d]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" />
	        		</div>
	        		<a href="javascript:save()" class="next_bton">确定</a>
	        	</div>
	        </div>	
        </form>
	</body>

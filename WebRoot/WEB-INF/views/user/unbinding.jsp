...
<style type="text/css">
	...
	.l_content { width: 100%; background-color: #white; margin-bottom: 10px;}
    ...
    .moren_num { display: inline-block; margin: 15px 15px;}
    .kong { width: 100%; height: 10px; background-color: #fff;}
</style>
</head>
...
<body>
    ...
    <form id="verifyForm" action="" method="post" >
	    ...
	    <div class="l_content">
	    	<div class="input_box">
	    		<em class="moren_num">${verifyPhone.phoneNo}</em>
	        	<input type="hidden" class="userphone" id="bind_phone" name="phone" maxlength="11" value="${verifyPhone.phoneNo}" placeholder="请输入您的手机号">
...
function save(){
	...
	var path = '<%=basePath%>verify/matching2';

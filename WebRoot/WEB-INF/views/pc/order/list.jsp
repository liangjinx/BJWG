...
<div class="right_main">
    ...
    <div class="mypig_body" style="min-height: 600px;"> 
            ...
            <div class="orders_tab_box">
            	<a class="orders_but all_orders_but ${(status == null or status == 0) ? 'this_orders' :'' }" href="pc/pv/order/list">全部订单</a>
                <a class="orders_but dfk_orders_but ${(status != null and status == 1) ? 'this_orders' :'' }" href="pc/pv/order/list?status=1">待付款</a>
                <a class="orders_but dsh_orders_but ${(status != null and status == 4) ? 'this_orders' :'' }" href="pc/pv/order/list?status=4">待收货</a>
                <div class="clear"></div>

<%@page import="com.bjwg.main.chinapay.util.PathUtil"%>
...
<form name="payment" action="<%= pay_url %>" method="POST">
	<table border="1" cellpadding="2" cellspacing="0" style="border-collapse: collapse;display:none" bordercolor="#111111">
		<tr>
			<td>
...
%>
	如果您的浏览器没有跳转，请点击按钮<input type='button' value='提交订单' onClick='document.payment.submit()'>再次提交。
</form>

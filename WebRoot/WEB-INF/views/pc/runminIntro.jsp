		...
		<div class="d-contain">
			<div class="d-nav fl-left of-hide">
				<div class="nav-cnt fl-right">
					...
					<div class="list">
						<a href="pc/pnv/runminIntro" class="current">润民简介<i class="d-icon"></i></a> 
			...
			<div class="of-hide" style="width:968px; float: right;">
					<div class="d-contain about-cont" style="width:960px;">
						...
						<div class="section">
							<h2 class="title">润民简介</h2>
						</div>
						
						<div class="section">
					        <p>深圳润民互联网生态农业科技有限公司（简称润民科技或润民）是一家完全与国际接轨的、具备独立法人资格的现代农业企业，是中国生猪全产业链经营的倡导者和先行者。润民全产业链包含种植、饲料、草本兽药、生态养殖与育种、屠宰与猪肉深加工、生物制药、有机肥料生产、品牌连锁八大版块，把控从农场到餐桌的各个环节，确保食品优质安全。</p>
					        <img src="resources/images/runminIntro-1.jpg" style="width: 602px;height: 451px">
					    </div>
					    ...
					    <div class="section">
					        ...
					        <img src="resources/images/runminIntro-2.jpg" style="width: 303px;height: 237px">
					    </div>
					    ...
					    <div class="section">
					        ...
					        <img src="resources/images/runminIntro-3.jpg" style="width: 352px;height: 56px">
					    </div>

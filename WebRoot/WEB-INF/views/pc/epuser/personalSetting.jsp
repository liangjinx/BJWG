...
.basicinfo_self{ width:430px; height:36px; line-height:36px; float:left; outline:0px; border:0px solid #ccc; margin-left:20px;font-family: "Microsoft YaHei"; font-size:16px;  text-indent: 1em;}
...
<div class="basicinfo_b" id="basicInfoModifyPanel">
    ...
    <input type="hidden" id="flag" value="${user.flag}">
	    <div class="basicinfo_main">
	    	<p class="p_16 h_36"> 公司名称: </p>	 
	    	<span class="basicinfo_self">${user.nickname}</span>
	    </div>
	    <div class="basicinfo_main">
	    	<p class="p_16 h_36"> 营业执照号码: </p>
	 <span class="basicinfo_self">${user.businessLicense}</span>
	      
	    </div>
	     <div class="basicinfo_main">
	    	<p class="p_16 h_36"> 企业法人代表: </p>
	 <span class="basicinfo_self">${user.legalperson}</span>
	    </div>
	      <div class="basicinfo_main">
	    	<p class="p_16 h_36">企业电话号码: </p>
	 <span class="basicinfo_self">  ${user.phone}</span>
	    </div>
	      <div class="basicinfo_main">
	    	<p class="p_16 h_36"> 企业地址: </p>
	    <span class="basicinfo_self">	${user.address}</span>
	    </div>

...
<div class="basicinfo_b" id="basicInfoModifyPanel">
    ...
    <form>
	    <div class="basicinfo_main">
	    	<p class="p_16 h_36"> 用户名:</p> ${user.nickname}
	    </div>
	    <div class="basicinfo_main">
	   ...
	   ${user.businessLicense}
	     ...
	     <div class="basicinfo_main">
	    	<p class="p_16 h_36"> 企业法人代表: </p>${user.legalperson}

	    </div>
	      <div class="basicinfo_main">
	    	<p class="p_16 h_36">企业电话号码:  ${user.phone}</p>
	    </div>
	      <div class="basicinfo_main">
	    	<p class="p_16 h_36"> 企业地址: </p>${user.address}
	    </div>

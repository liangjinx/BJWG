...
<div class="right_main">
	<div class="mypig_box"><!--mypig_box -->
     ...
     <li><p>本期收益：${farmData.profit }元</p></li>
...
<div class="biao_box">
    ...
    <div class="biao_box_p"><p class="p_tit" style="margin-top: 10px;">温馨提示：</p><p style=" height: auto; line-height:24px; margin-left: 200px; margin-right: 50px;">两种抢标方式只可选择一种；抢购成功需要在1小时内完成付款，否则视为放弃抢购。</p></div>

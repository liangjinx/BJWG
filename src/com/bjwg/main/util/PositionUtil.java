...
public class PositionUtil {  
     ...
     */
    public static String getBaiDuLocationXY(String x, String y) throws HttpException, IOException {
	...
	public static Double[] parseJson(String sms) throws Exception{
		...
		if(object.getString("error").equals("0")){
			...
			byte[] xbuff = Base64.decodeBase64(object.getString("x"));
            byte[] ybuff = Base64.decodeBase64(object.getString("y"));
            
            String result = new String(xbuff) + "|" + new String(ybuff);
			
            String[] strings = result.split("|");
            
			Double[] d = new Double[]{ Double.valueOf(strings[0]) ,Double.valueOf(strings[1])}; 

...
public class RequestHandler {
	...
	public String genPackage(SortedMap<String, String> packageParams) throws UnsupportedEncodingException {
		...
		// ConsoleUtil.println("UrlEncode后 packageValue=" + packageValue);
		return packageValue;
	}
	...
	public String createSign(SortedMap<String, String> packageParams) {
		...
		while (it.hasNext()) {
			...
			String k = (String) entry.getKey();
			String v = (String) entry.getValue();
			if (null != v && !"".equals(v) && !"sign".equals(k) && !"key".equals(k) && !"jsonObject".equals(k)) {
				sb.append(k + "=" + v + "&");
			}
		...
		String sign = MD5.GetMD5Code(sb.toString(), this.charset).toUpperCase();
	...
	public boolean createMd5Sign(String signParams) {
		...
		String sign = MD5.GetMD5Code(sb.toString(), enc).toLowerCase();
